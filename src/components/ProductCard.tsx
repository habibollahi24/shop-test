  ...
  return (
    <Link href={`/products/${id}`}>
      <div className="relative p-4 shadow-lg rounded-xl cursor-pointer hover:shadow-xl transition-all group">
        ...
        <div className="group-hover:hidden flex items-end justify-between mt-8  text-gray-600">
        ...
        <div className="md:hidden flex group-hover:flex items-center justify-between mt-8  text-gray-600 ">
          <AddToCartBtn
